...
export async function contextPackCommand(context: CommandContext): Promise<CommandResult> {
  ...
  return {
    ...
    data: {
      ...
      artifactRole: pack.artifactRole,
      status: pack.status,
      contextPackRole: pack.contextPackRole,
      sourceMaintainabilityGraph: pack.sourceMaintainabilityGraph,
      sourceViewTree: pack.sourceViewTree,
      sourceViewTreeArtifactRole: pack.sourceViewTreeArtifactRole,
      contextPackGenerated: pack.contextPackGenerated,
      graphSourceMutated: pack.graphSourceMutated,
      graphDeltaApplied: pack.graphDeltaApplied,
      runtimeEvidenceSatisfied: pack.runtimeEvidenceSatisfied,
      equivalenceProven: pack.equivalenceProven,
      scopeEnforced: pack.scopeEnforced,
      ciEnforcementEnabled: pack.ciEnforcementEnabled,
