...
Options:
  ...
  --extension-adapter-compatibility-report <file>
                       Project-specific extension adapter compatibility report for graph read-model report-devview-baseline or work-journal render.
