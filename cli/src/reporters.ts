...
Options:
  ...
  --validation-output <file>
                       Validation output for graph import-graphify-code-subgraph, graph read-model run-clarification-chain, or post-mutation graph read-model apply-graph-delta/apply-guarded-graph-update.
