...
Options:
  ...
  --equivalence-proof-record <file>
                       Equivalence Proof record file for graph read-model record-scope-ci-enforcement or work-journal render.
  ...
  --scope-ci-enforcement-record <file>
                       Scope/CI Enforcement record file for graph read-model report-devview-baseline or work-journal render.
