...
| DEC-050 | active | The user approved and Codex implemented a bounded scoped read-model validator command for the Todo Search selected slice. `pbe graph read-model validate --slice examples/internal-legacy/adoption/todo-search-slice` creates validator-backed Evidence reports with `validation-pass` status for the current generated read-model and parity artifacts. This is local scoped Evidence only; it does not add CI workflow or enforcement, expand pilot scope, change source authority, retire tree-native artifacts, clean up public docs, or approve full Graph-source promotion.                                                                                                                                                                                                                                                                                                                                      | Scoped Read-Model Validator-Backed Evidence                                       |
