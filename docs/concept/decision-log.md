...
| DEC-012 | active | Actual runtime demo execution, rollback/compatibility strategy, Graph-source promotion, and implementation details remain next-phase candidates. Concept policies through Source Transition Path are promoted.         | Attached v2.1 work instruction; updated by Source Transition Path |
