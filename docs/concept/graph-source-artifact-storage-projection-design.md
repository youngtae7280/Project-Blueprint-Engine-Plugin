...
| `.devview/graph/source.json`                                                      | Closer to future canonical repo layout.                                 | Repo has no active `.devview/` artifacts here; premature for example-scope branch.               | Future-only.                     |
