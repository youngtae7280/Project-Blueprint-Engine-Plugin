...
| Aggregate validate-all summary           | `examples/internal-legacy/read-model-aggregate/generated/read-model-aggregate-summary.json`, `read-model-aggregate-summary.md`                                                                                                                    | `aggregate-pass`; positive registry includes Todo Search and Todo App PBE Run only.                                                                  |
