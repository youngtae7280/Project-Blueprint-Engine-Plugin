...
| 7. Public-doc cleanup / compatibility wording | Batch A corrected the strongest `docs/source-of-truth-matrix.md` authority ambiguity; remaining Batch B/C/D risks are known and retained as warnings.    | Not ready for full promotion unless remaining cleanup is completed, reviewed, or explicitly waived.              |
...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Public-doc cleanup or explicit waiver     | Batch A cleanup removed the strongest `docs/source-of-truth-matrix.md` ACEP task-card authority ambiguity, but Batch B/C/D public-doc cleanup and waiver approval remain undone. |
...
| Public-doc cleanup preparation      | Review Batch A wording and decide whether to implement Batch B/C/D or explicitly waive remaining public-doc cleanup before broader promotion. |
...
- implement remaining Batch B/C/D public-doc cleanup
