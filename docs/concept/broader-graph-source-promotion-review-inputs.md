...
| 7. Public-doc cleanup / compatibility wording | Batch A corrected the strongest source-of-truth matrix authority ambiguity; Batch B reframed task-card shorthand docs; Batch C reframed examples, usage, traceability, and audit wording. | Near the 80% review threshold; Batch D remains optional/review-only unless a concrete ambiguity is found or explicitly waived. |
...
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Public-doc cleanup or explicit waiver     | Batch A/B/C cleanup removed the strongest source-of-truth matrix, task-card shorthand, examples, usage, traceability, and audit wording ambiguities; Batch D review and waiver approval remain undone. |
...
| Public-doc cleanup preparation      | Review Batch A/B/C wording and decide whether optional Batch D review is needed or whether remaining cleanup can stay explicitly deferred. |
...
- implement optional Batch D public-doc cleanup
