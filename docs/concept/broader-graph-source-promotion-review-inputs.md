...
| 7. Public-doc cleanup / compatibility wording | Batch A corrected the strongest source-of-truth matrix authority ambiguity; Batch B reframed task-card shorthand docs; remaining Batch C/D risks are retained as warnings. | Not ready for full promotion unless remaining cleanup is completed, reviewed, or explicitly waived.              |
...
| ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Public-doc cleanup or explicit waiver     | Batch A/B cleanup removed the strongest source-of-truth matrix and task-card shorthand authority ambiguities, but Batch C/D public-doc cleanup and waiver approval remain undone. |
...
| Public-doc cleanup preparation      | Review Batch A/B wording and decide whether to implement Batch C/D or explicitly waive remaining public-doc cleanup before broader promotion. |
...
- implement remaining Batch C/D public-doc cleanup
