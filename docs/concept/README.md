...
external candidate. External candidate import remains the only candidate-producing path, and unsafe or secret-looking
provider config blocks even external import.
