...
batches. Batch A, Batch B, and Batch C are now implemented as review candidates; Batch D remains optional/review-only and
...
| Public-doc cleanup status classified                                        | ready with warning | Batch A source-of-truth matrix cleanup, Batch B task-card shorthand cleanup, and Batch C examples/usage/traceability/audit cleanup are implemented as review candidates; optional Batch D review remains visible.         |
...
| ACEP task-card public-doc cleanup mostly implemented       | deferred cleanup                 | Batch A/B/C corrected the highest-signal matrix, shorthand, example, usage, traceability, and audit wording. Optional Batch D review still needs review, explicit defer, or waiver before promotion.         | Review Batch A/B/C and decide optional Batch D cleanup-before-promotion or accepted deferred cleanup.                                                                                  |
...
- ask the user whether optional Batch D public-doc review may remain deferred for the promotion decision
...
| Public-doc cleanup                              | mostly implemented | Batch A/B/C are implemented as review candidates; optional Batch D cleanup must be accepted as a caveat, waived, or resolved before promotion approval.                                       |
...
2. review Batch A/B/C and defer, waive, or require optional Batch D public-doc cleanup before full promotion,
...
validator-backed Evidence, and Batch A/B/C public-doc cleanup are recorded. Full promotion, broad source authority change,
...
| ACEP public-doc cleanup mostly implemented                | Compatibility Control Node   | Active / Batch A+B+C review candidate                   | Batch A/B/C corrected the strongest matrix, shorthand, examples, usage, traceability, and audit wording; optional Batch D remains a cleanup caveat. | Show in promotion readiness and promotion decision review.              |
...
- Whether optional Batch D public-doc cleanup must happen before promotion approval or may remain deferred with an
