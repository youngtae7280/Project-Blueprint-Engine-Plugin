...
batches. Batch A and Batch B are now implemented as review candidates; Batch C/D remain unimplemented and no waiver is
approved.
...
| Public-doc cleanup status classified                                        | ready with warning | Batch A source-of-truth matrix cleanup and Batch B task-card shorthand cleanup are implemented as review candidates; remaining Batch C/D cleanup is still a Compatibility Control Node candidate and explicit readiness warning. |
...
| ACEP task-card public-doc cleanup partially implemented    | deferred cleanup                 | Batch A corrected the highest-signal source-of-truth matrix wording, and Batch B reframed task-card shorthand docs. Remaining Batch C/D public-doc wording still needs cleanup, review, or explicit waiver before promotion. | Review Batch A/B and decide Batch C/D cleanup-before-promotion or accepted deferred cleanup.                                                                                           |
...
- ask the user whether remaining Batch C/D public-doc cleanup may remain deferred for the promotion decision
...
| Public-doc cleanup                              | partially implemented | Batch A and Batch B are implemented as review candidates; remaining Batch C/D cleanup must be accepted as a caveat, waived, or resolved before promotion approval.                            |
...
2. review Batch A/B and defer, waive, or require remaining Batch C/D public-doc cleanup before full promotion,
...
validator-backed Evidence, and Batch A/B public-doc cleanup are recorded. Full promotion, broad source authority change,
...
| ACEP public-doc cleanup partially implemented             | Compatibility Control Node   | Active / Batch A+B review candidate                     | Batch A corrected the strongest matrix wording, and Batch B reframed task-card shorthand docs; remaining Batch C/D wording remains a cleanup caveat. | Show in promotion readiness and promotion decision review.              |
...
- Whether remaining Batch C/D public-doc cleanup must happen before promotion approval or may remain deferred with an
