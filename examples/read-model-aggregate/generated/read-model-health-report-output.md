...
| Contract semantic diff review           | `compiler-promotion-not-ready`; severity `high`; unknown semantic diffs 1; unknown fields outputRequirements; conservative-restriction: 1, policy-loss: 2, policy-expansion: 2, semantic-loss: 3, safe-additive: 3, evidence-chain-mismatch: 1, metadata-only: 2, unknown-review-required: 1 |
