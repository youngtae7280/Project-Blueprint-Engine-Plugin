...
| Contract semantic diff review           | `compiler-promotion-not-ready`; severity `high`; unknown semantic diffs 6; conservative-restriction: 1, policy-loss: 1, policy-expansion: 1, safe-additive: 1, semantic-loss: 1, evidence-chain-mismatch: 1, unknown-review-required: 6 |
