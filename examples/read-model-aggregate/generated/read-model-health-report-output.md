...
| Contract compiler promotion review packet   | `promotion-review-ready-for-human`; approval `not-approved`; equivalence candidate `true`; equivalence proven `false`; review-only diffs 3; checklist 6 pass / 5 decision-required / 0 blocked; `examples/read-model-aggregate/generated/contract-compiler-promotion-review.preview.json` |
