...
| Generated vs hand-written contract diff     | `contract-diff-detected`; `non-blocking-review-diff`; `compiler-equivalence-not-proven`; 6 differing fields; `examples/read-model-aggregate/generated/execution-contract-dry-run.diff.json`                                                                       |
...
| Source authority gap preview                | `contract-source-authority-gap-preview-pass`; 2 remaining losses (2 semantic / 0 policy); fields allowedScope, requiredContext, knownRisks; next `context-source-authority`; `examples/read-model-aggregate/generated/contract-source-authority-gap.preview.json` |
| Contract semantic diff review               | `compiler-promotion-not-ready`; severity `high`; unknown semantic diffs 0; unknown fields none; conservative-restriction: 1, semantic-loss: 2, safe-additive: 3, metadata-only: 2                                                                                 |
