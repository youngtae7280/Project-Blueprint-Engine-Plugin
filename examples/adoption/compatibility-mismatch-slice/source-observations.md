...
| `docs/concept/control-node-policy.md`      | Old ACEP/task-card-only wording can become a Compatibility Control Node or superseded item record.                                                      | Control boundary for current judgment or promotion review.                                                                     | present         |
